...
<section
	class="projects-home"
	<?php if ( $tmnhanphat_pj_section_id ) : ?>
		id="<?php echo esc_attr( $tmnhanphat_pj_section_id ); ?>"
	<?php endif; ?>
>
	...
	<div class="container projects-home__container">
		...
		<div
			class="projects-home__slider tmnp-slider"
			role="region"
			aria-roledescription="carousel"
			aria-label="<?php esc_attr_e( 'Dự án tiêu biểu', 'tmnhanphat' ); ?>"
			<?php echo $tmnhanphat_pj_attr_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- từng name/value đã esc_attr() khi build ở trên. ?>
		>
						...
						<article class="tmnp-slider__slide project-card">
							<div class="project-card__content">
								...
								<?php if ( $tmnhanphat_pj_excerpt ) : ?>
									<p class="project-card__description"><?php echo $tmnhanphat_pj_excerpt; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- helper trả chuỗi đã esc_html() sẵn. ?></p>
								<?php endif; ?>
									...
									<ul class="project-card__meta">
										<?php foreach ( $tmnhanphat_pj_meta_items as $tmnhanphat_pj_meta ) : ?>
											<li class="project-card__meta-item">
												<span class="project-card__meta-label"><?php echo esc_html( $tmnhanphat_pj_meta['label'] ); ?></span>
												<span class="project-card__meta-value"><?php echo esc_html( $tmnhanphat_pj_meta['value'] ); ?></span>
											</li>
										<?php endforeach; ?>
									</ul>
								<?php endif; ?>
							...
							<div class="project-card__media">
								<a class="project-card__media-link" href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1">
